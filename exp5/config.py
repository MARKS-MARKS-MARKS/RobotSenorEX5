...
DEFAULT_CONFIG: dict[str, Any] = {
    ...
    "detector": {
        ...
        "local_model_dir": "models/groundingdino",
        ...
        "allow_fallback": True,
        "prompts": {
            "Cutlery": ["fork", "knife", "spoon", "metal spoon", "teaspoon", "chopsticks", "table knife", "silverware"],
            ...
            "Soft Drink": ["cola", "ice tea", "iced tea", "soft drink", "soda", "soda can", "cola can", "beverage bottle", "juice", "water bottle"],
        },
        "unknown_prompts": [
            "object",
            "item",
    ...
    "geometry": {
        ...
        "roi_color_auto_enabled": True,
        "roi_dark_percentile": 56,
        "roi_dark_threshold_min": 52,
        "roi_dark_threshold_max": 82,
        "roi_dark_min_area_ratio": 0.25,
        "roi_dark_column_min_ratio": 0.18,
        "roi_dark_row_min_ratio": 0.16,
        "roi_inner_margin_px": 3,
        "roi_edge_min_ratio": 0.35,
        "voxel_size_m": 0.01,
        "min_valid_depth_ratio": 0.10,
        "shelf_split_mode": "point_cloud",
        "shelf_count": 3,
        "shelf_boundaries_px": None,
        "shelf_boundaries_norm": None,
        "shelf_refine_equal_boundaries": True,
        "shelf_refine_search_px": 45,
        "shelf_refine_min_gradient": 1.0,
        "shelf_point_sample_stride_px": 2,
        "shelf_pointcloud_infer_count": True,
        "shelf_pointcloud_expected_count_fallback": True,
        "shelf_pointcloud_min_shelf_count": 2,
        "shelf_pointcloud_max_shelf_count": 6,
        "shelf_pointcloud_expected_distance_penalty": 8.0,
        "shelf_plane_y_bin_m": 0.018,
        "shelf_plane_min_points": 45,
        "shelf_plane_min_width_ratio": 0.34,
        "shelf_plane_min_depth_span_m": 0.02,
        "shelf_plane_min_score_ratio": 0.20,
        "shelf_plane_merge_gap_px": 18,
        ...
        "depth_obstacles_enabled": False,
        "obstacle_min_area_px": 280,
        "obstacle_min_width_px": 12,
        "obstacle_min_height_px": 14,
        "obstacle_color_foreground_enabled": False,
        "obstacle_color_delta": 34,
        "obstacle_max_area_ratio": 0.22,
        "obstacle_max_width_ratio": 0.46,
        "obstacle_max_height_ratio": 0.90,
        "semantic_unknown_max_area_ratio": 0.22,
        "semantic_unknown_max_width_ratio": 0.46,
        "semantic_unknown_min_score": 0.34,
        "semantic_unknown_obstacles_enabled": True,
        "obstacle_known_overlap_threshold": 0.45,
        "obstacle_inflate_px": 6,
        "empty_project_occupied_to_full_shelf": True,
        "empty_final_project_occupied": True,
        "empty_final_min_width_px": 8,
        "empty_object_shelf_overlap_min": 0.10,
        "empty_roi_column_min_ratio": 0.12,
        "empty_center_mode": "center",
        "empty_min_width_m": 0.04,
        "empty_min_height_m": 0.04,
        "empty_min_depth_m": 0.04,
        "empty_max_per_shelf": 6,
    ...
    "placement": {
        ...
        "candidate_item_size_m": [0.02, 0.02, 0.02],
        "size_safety_margin_m": 0.02,
        "same_category_bonus": 5.0,
        "same_category_same_shelf_bonus": 4.0,
